...
import { Avatar, Card,Divider, IconButton,Button,Colors ,  Title, Paragraph,DataTable } from 'react-native-paper';
	...
	return (
        <View  style={{backgroundColor : ' #22142b'}}>
            ...
            <View style={styles.topo}>
                ...
                <View 
                    style={{width: '50%',alignSelf:'center',alignContent:'flex-start',textAlign:'left'}}
                >

                    <Text style={{fontSize:23,color:'#dfc695',fontWeight:'bold'}}>Movimentações </Text>
            ...
            <View backgroundColor='#efefef' alignItems='center' width='100%' height='73%' >

                <View backgroundColor='white' marginTop='5%' width='90%' alignItems='center'  height='80%'style={styles.card} >

                    <View backgroundColor='white' width='90%' height='25%'   marginTop='5%' style={styles.card} >

                        <View  marginTop='3%'  marginLeft='5%' width ='100%' height='80%'  flexDirection="row">
                        
                            <View width ='50%' marginTop='0%' >
                                <Text style={{fontWeight:'bold',fontSize:18}}>Estabelecimento 1</Text>
                                <View flexDirection="row">
                                    <Image source={require("../../imagens/icones/saldo_final.png")} size={30} />
                                    <Text  style={{fontSize:16,fontWeight:'bold',marginTop:20}}>Saldo Final</Text>
                                </View>
                                
                            </View>       
                            <View width ='30%' marginTop='10%'>
                            
                                <Text style={{fontWeight :'bold',fontSize:20,alignSelf:'flex-end',marginTop:15}}>R$2,56</Text>
                            </View>   
                    ...
                    <Divider 
                          style={{height: 2,width:'100%', backgroundColor: "#dfc695"}}
                    
                    />
                    

                    <View backgroundColor='white' width='90%' height='20%'    style={styles.card} >

                        <View  marginTop='3%'  marginLeft='5%' width ='100%' height='80%' marginTop='5%' flexDirection="row">
                           
                            <View width ='50%' marginTop='5%' marginLeft='5%'>
                                <Text style={{fontSize:18,fontWeight:'bold'}}>Descrição</Text>
                                <Text  style={{fontSize:10}}>Ultima atualização : dd/mm/aaaa </Text>
                            </View>       
                            <View width ='30%' marginTop='3%'>
                                
                                <Text style={{fontWeight :'bold',alignSelf:'flex-end',top:10,fontSize:20}}>R$2,56</Text>
                            </View>   
